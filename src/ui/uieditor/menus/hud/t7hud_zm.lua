...
local PostLoadFunc = function ( f3_arg0, f3_arg1 )
	...
	if f3_local0 then
		...
		while f3_local3 do
			...
			f3_arg0.fullscreenContainer:subscribeToModel( Engine.GetModel( Engine.GetModelForController( f3_arg1 ), "playerConnected" ), function ( modelRef )
...
LUI.createMenu.T7Hud_ZM = function ( controller )
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.playerSpawned" ), function ( modelRef )
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_WEAPON_HUD_VISIBLE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_GAME_ENDED ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_CAMERA_MODE_MOVIECAM ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_ALL_GAME_HUD_HIDDEN ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_KILLCAM ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_SCOPED ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_VEHICLE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_REMOTE_KILLSTREAK_STATIC ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	Rounds:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_EMP_ACTIVE ), function ( modelRef )
		f7_local1:updateElementState( Rounds, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ZmNotifBGBContainerFactory:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "zombie_bgb_token_notification" ) then
			AddZombieBGBTokenNotification( self, f42_local0, controller, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_bgb_notification" ) then
			AddZombieBGBNotification( self, f42_local0, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_notification" ) then
			AddZombieNotification( self, f42_local0, modelRef )
		end
	end )
	...
	MPScore:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "score_event" ) and PropertyIsTrue( self, "menuLoaded" ) then
			...
			SetMPScoreText( f7_local1, f57_local0, controller, modelRef )
		end
	end )
	...
	FuseBoxWidget:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f58_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f58_local0 then
					f58_local0 = AlwaysFalse()
				end
				return f58_local0
			end
		}
	} )
	FuseBoxWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_fuses" ), function ( modelRef )
	...
	FuseBoxWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f7_local1:updateElementState( FuseBoxWidget, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	RocketShieldBlueprintWidget:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f61_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f61_local0 then
					f61_local0 = AlwaysFalse()
				end
				return f61_local0
			end
		}
	} )
	RocketShieldBlueprintWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_shield_parts" ), function ( modelRef )
	...
	RocketShieldBlueprintWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f7_local1:updateElementState( RocketShieldBlueprintWidget, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	IDGunBlueprintWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_idgun_parts" ), function ( modelRef )
	...
	RitualWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_quest_items" ), function ( modelRef )
	...
	SprayerWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.player_using_sprayer" ), function ( modelRef )
	...
	SprayerWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_sprayer" ), function ( modelRef )
		f7_local1:updateElementState( SprayerWidget, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	SprayerWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.pod_sprayer_hint_range" ), function ( modelRef )
		f7_local1:updateElementState( SprayerWidget, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	SprayerWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.pod_sprayer_held" ), function ( modelRef )
		f7_local1:updateElementState( SprayerWidget, {
			name = "model_validation",
			menu = f7_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	QuestEggWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_egg" ), function ( modelRef )
