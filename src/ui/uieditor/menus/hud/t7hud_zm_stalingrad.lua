...
LUI.createMenu.T7Hud_zm_stalingrad = function ( controller )
	...
	TrialWidget:subscribeToGlobalModel( controller, "ZMStalingradChallenges", "icon", function ( modelRef )
		local icon = Engine.GetModelValue( modelRef )
		if icon then
			TrialWidget.InProgressImage:setImage( RegisterImage( GetChallengeIcon( icon ) ) )
		end
	end )
	TrialWidget:subscribeToGlobalModel( controller, "ZMStalingradChallenges", "progress", function ( modelRef )
	...
	MPScore:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "score_event" ) then
			...
			SetMPScoreText( f4_local1, f50_local0, controller, modelRef )
		end
	end )
	...
	PodControlWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_cylinder" ), function ( modelRef )
	...
	DragonCollarControllerWidgets:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_dragonride_parts" ), function ( modelRef )
	...
	DragonShieldWidgets:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_shield_parts" ), function ( modelRef )
	...
	DragonEggWidget:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f57_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f57_local0 then
					f57_local0 = AlwaysFalse()
				end
				return f57_local0
			end
		}
	} )
	DragonEggWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
	...
	DragonEggWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.piece_egg" ), function ( modelRef )
		f4_local1:updateElementState( DragonEggWidget, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	DragonEggWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_egg" ), function ( modelRef )
		f4_local1:updateElementState( DragonEggWidget, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	DragonStrikeWidgetsStalingrad:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_dragon_strike" ), function ( modelRef )
	...
	DragonStrikeWidgetsStalingrad:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f4_local1:updateElementState( DragonStrikeWidgetsStalingrad, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
