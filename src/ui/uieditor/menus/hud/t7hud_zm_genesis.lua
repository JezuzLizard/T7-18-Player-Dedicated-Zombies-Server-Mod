...
local PostLoadFunc = function ( f2_arg0, f2_arg1 )
	...
	f2_arg0.TrialWidgetGenesis0:subscribeToGlobalModel( f2_arg1, "PerController", "scriptNotify", function ( modelRef )
		if Engine.GetModelValue( modelRef ) == "trial_set_description" then
			local f3_local0 = CoD.GetScriptNotifyData( modelRef )
...
LUI.createMenu.T7Hud_zm_genesis = function ( controller )
	...
	ZmNotifBGBContainerFactory:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "zombie_bgb_token_notification" ) then
			AddZombieBGBTokenNotification( self, f22_local0, controller, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_bgb_notification" ) then
			AddZombieBGBNotification( self, f22_local0, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_notification" ) then
			AddZombieNotification( self, f22_local0, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_time_attack_notification" ) then
			AddZombieTimeAttackNotification( self, f22_local0, modelRef )
		end
	end )
	...
	MPScore:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "score_event" ) and PropertyIsTrue( self, "menuLoaded" ) then
			...
			SetMPScoreText( f4_local1, f37_local0, controller, modelRef )
		end
	end )
	...
	WearableBenefitsWidget:subscribeToGlobalModel( controller, "ZMPlayerList", "0.zombieWearableIcon", function ( modelRef )
		local ZombieWearableIcon = Engine.GetModelValue( modelRef )
		if ZombieWearableIcon then
			WearableBenefitsWidget.wearableBenefits:setText( Engine.Localize( GetGenesisWearableDescription( ZombieWearableIcon ) ) )
		end
	end )
	...
	TrialWidgetGenesis0:subscribeToGlobalModel( controller, "ZMGenesisChallenges", "icon", function ( modelRef )
		local icon = Engine.GetModelValue( modelRef )
		if icon then
			TrialWidgetGenesis0.InProgressImage:setImage( RegisterImage( GetChallengeIcon( icon ) ) )
		end
	end )
	TrialWidgetGenesis0:subscribeToGlobalModel( controller, "ZMGenesisChallenges", "progress", function ( modelRef )
		local progress = Engine.GetModelValue( modelRef )
		if progress then
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "trialWidget.visible" ), function ( modelRef )
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidgetGenesis0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f4_local1:updateElementState( TrialWidgetGenesis0, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ApothiconGatewormWidget:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f52_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f52_local0 then
					f52_local0 = not IsEitherInventoryItemVisible( controller, "widget_gate_worm", "widget_apothicon_egg" )
				end
				return f52_local0
			end
		},
		...
		},
		{
			stateName = "BgVisible",
			condition = function ( menu, element, event )
				local f54_local0 = IsEitherInventoryItemVisible( controller, "widget_gate_worm", "widget_apothicon_egg" )
				if f54_local0 then
					f54_local0 = not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT )
				end
				return f54_local0
			end
		}
	} )
	ApothiconGatewormWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
	...
	ApothiconGatewormWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_gate_worm" ), function ( modelRef )
		f4_local1:updateElementState( ApothiconGatewormWidget, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ApothiconGatewormWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_apothicon_egg" ), function ( modelRef )
		f4_local1:updateElementState( ApothiconGatewormWidget, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ApothiconGatewormWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ), function ( modelRef )
		f4_local1:updateElementState( ApothiconGatewormWidget, {
			name = "model_validation",
			menu = f4_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	KeeperProtectorWidgetsGenesis:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_keeper_protector_parts" ), function ( modelRef )
	...
	RocketShieldWidgetGenesis:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_shield_parts" ), function ( modelRef )
	...
	self:subscribeToGlobalModel( controller, "PerController", "GenesisEndGameEE", function ( modelRef )
