...
local PostLoadFunc = function ( f2_arg0, f2_arg1 )
	...
	if f2_local0 then
		f2_arg0.TrialWidget:subscribeToModel( f2_local0, function ( modelRef )
	...
	f2_arg0.TrialWidget:subscribeToGlobalModel( f2_arg1, "PerController", "scriptNotify", function ( modelRef )
		if Engine.GetModelValue( modelRef ) == "trial_set_description" then
			local f4_local0 = CoD.GetScriptNotifyData( modelRef )
...
LUI.createMenu.T7Hud_zm_island = function ( controller )
	...
	ZmNotifBGBContainerFactory:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "zombie_bgb_token_notification" ) then
			AddZombieBGBTokenNotification( self, f23_local0, controller, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_bgb_notification" ) then
			AddZombieBGBNotification( self, f23_local0, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_notification" ) then
			AddZombieNotification( self, f23_local0, modelRef )
		end
	end )
	...
	MPScore:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "score_event" ) and PropertyIsTrue( self, "menuLoaded" ) then
			...
			SetMPScoreText( f5_local1, f38_local0, controller, modelRef )
		end
	end )
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "trialWidget.visible" ), function ( modelRef )
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "trialWidget.progress" ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	TrialWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f5_local1:updateElementState( TrialWidget, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	GasMaskStatus0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.showCursorHint" ), function ( modelRef )
	...
	GasMaskStatus0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "trialWidget.visible" ), function ( modelRef )
		f5_local1:updateElementState( GasMaskStatus0, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	GasMaskStatus0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.gaskmask_gasmask_active" ), function ( modelRef )
		f5_local1:updateElementState( GasMaskStatus0, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	GasMaskStatus0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.gaskmask_gasmask_progress" ), function ( modelRef )
		f5_local1:updateElementState( GasMaskStatus0, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	IslandSkullWidget0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_skull_parts" ), function ( modelRef )
	...
	BucketAndSeedWidget0:mergeStateConditions( {
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				local f58_local0 = ShowBucketOrSeedWidget( controller )
				if f58_local0 then
					f58_local0 = not Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				end
				return f58_local0
			end
		}
	} )
	BucketAndSeedWidget0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_bucket_parts" ), function ( modelRef )
	...
	BucketAndSeedWidget0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_seed_parts" ), function ( modelRef )
		f5_local1:updateElementState( BucketAndSeedWidget0, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	BucketAndSeedWidget0:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f5_local1:updateElementState( BucketAndSeedWidget0, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	RocketShield:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f62_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f62_local0 then
					f62_local0 = AlwaysFalse()
				end
				return f62_local0
			end
		}
	} )
	RocketShield:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_shield_parts" ), function ( modelRef )
	...
	RocketShield:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f5_local1:updateElementState( RocketShield, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	GasMask:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f65_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f65_local0 then
					f65_local0 = AlwaysFalse()
				end
				return f65_local0
			end
		}
	} )
	GasMask:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_gasmask_parts" ), function ( modelRef )
	...
	GasMask:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f5_local1:updateElementState( GasMask, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MachineTools:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f68_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f68_local0 then
					f68_local0 = AlwaysFalse()
				end
				return f68_local0
			end
		}
	} )
	MachineTools:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_machinetools_parts" ), function ( modelRef )
	...
	MachineTools:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f5_local1:updateElementState( MachineTools, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	WonderWeapon:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f71_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f71_local0 then
					f71_local0 = AlwaysFalse()
				end
				return f71_local0
			end
		}
	} )
	WonderWeapon:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_wonderweapon_parts" ), function ( modelRef )
	...
	WonderWeapon:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f5_local1:updateElementState( WonderWeapon, {
			name = "model_validation",
			menu = f5_local1,
			modelValue = Engine.GetModelValue( modelRef ),
