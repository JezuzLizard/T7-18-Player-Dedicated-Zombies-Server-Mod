...
local PostLoadFunc = function ( f4_arg0, f4_arg1 )
	...
	local f4_local0 = function ( f5_arg0, f5_arg1 )
		...
		if f5_local0 then
			...
			f5_local10:subscribeToModel( f5_local6, function ( modelRef )
			...
			if f5_local13 ~= nil then
				f5_local10:subscribeToModel( f5_local13, function ( modelRef )
					f5_local10:update( {
						controller = f5_local11
					} )
				end )
			end
			f5_local10:subscribeToModel( Engine.GetModel( f5_local5, "progress" ), function ( modelRef )
				f5_local10:update( {
					controller = f5_local11,
					progress = Engine.GetModelValue( modelRef )
				} )
			end )
			f5_local10:subscribeToModel( Engine.GetModel( f5_local5, "clientUseMask" ), function ( modelRef )
				f5_local10:update( {
					controller = f5_local11,
			...
			if f5_local14 then
				f5_local10:subscribeToModel( f5_local14, function ( modelRef )
					f5_local10:update( {
						controller = f5_local11
					} )
				end, false )
	...
	f4_arg0:subscribeToModel( Engine.CreateModel( Engine.GetModelForController( f4_arg1 ), "newObjectiveType" .. Enum.ObjectiveTypes.OBJECTIVE_TYPE_WAYPOINT ), function ( modelRef )
...
LUI.createMenu.T7Hud_zm_tomb = function ( controller )
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_WEAPON_HUD_VISIBLE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_GAME_ENDED ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_CAMERA_MODE_MOVIECAM ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_ALL_GAME_HUD_HIDDEN ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_KILLCAM ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_SCOPED ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_VEHICLE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_REMOTE_KILLSTREAK_STATIC ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_EMP_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletClean:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.player_tablet_state" ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletClean, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_WEAPON_HUD_VISIBLE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_GAME_ENDED ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_CAMERA_MODE_MOVIECAM ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_ALL_GAME_HUD_HIDDEN ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_KILLCAM ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_SCOPED ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_VEHICLE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_REMOTE_KILLSTREAK_STATIC ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_EMP_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	stoneTabletDirty:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.player_tablet_state" ), function ( modelRef )
		f12_local1:updateElementState( stoneTabletDirty, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	}
	-- } )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.playerSpawned" ), function ( modelRef )
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_WEAPON_HUD_VISIBLE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_GAME_ENDED ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_CAMERA_MODE_MOVIECAM ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_ALL_GAME_HUD_HIDDEN ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_KILLCAM ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_SCOPED ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_VEHICLE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_REMOTE_KILLSTREAK_STATIC ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	-- 	} )
	-- end )
	-- Score:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_EMP_ACTIVE ), function ( modelRef )
	-- 	f12_local1:updateElementState( Score, {
	-- 		name = "model_validation",
	-- 		menu = f12_local1,
	-- 		modelValue = Engine.GetModelValue( modelRef ),
	...
	ZmNotifBGBContainerFactory:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "zombie_bgb_token_notification" ) then
			AddZombieBGBTokenNotification( self, f64_local0, controller, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_bgb_notification" ) then
			AddZombieBGBNotification( self, f64_local0, modelRef )
		elseif IsParamModelEqualToString( modelRef, "zombie_notification" ) then
			AddZombieNotification( self, f64_local0, modelRef )
		end
	end )
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.showCursorHint" ), function ( modelRef )
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_DEMO_PLAYING ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SELECTING_LOCATIONAL_KILLSTREAK ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SPECTATING_CLIENT ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CursorHint:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "hudItems.cursorHintIconRatio" ), function ( modelRef )
		f12_local1:updateElementState( CursorHint, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MPScore:subscribeToGlobalModel( controller, "PerController", "scriptNotify", function ( modelRef )
		...
		if IsParamModelEqualToString( modelRef, "score_event" ) and PropertyIsTrue( self, "menuLoaded" ) then
			...
			SetMPScoreText( f12_local1, f80_local0, controller, modelRef )
		end
	end )
	...
	RocketShieldWidgetTomb:mergeStateConditions( {
		{
			...
			condition = function ( menu, element, event )
				local f81_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f81_local0 then
					f81_local0 = AlwaysFalse()
				end
				return f81_local0
			end
		}
	} )
	RocketShieldWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
	...
	RocketShieldWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.widget_shield_parts" ), function ( modelRef )
		f12_local1:updateElementState( RocketShieldWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ElementalStaffsWidget:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f84_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f84_local0 then
					f84_local0 = AlwaysFalse()
				end
				return f84_local0
			end
		}
	} )
	ElementalStaffsWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.air_staff.visible" ), function ( modelRef )
	...
	ElementalStaffsWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.fire_staff.visible" ), function ( modelRef )
		f12_local1:updateElementState( ElementalStaffsWidget, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ElementalStaffsWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.lightning_staff.visible" ), function ( modelRef )
		f12_local1:updateElementState( ElementalStaffsWidget, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ElementalStaffsWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.water_staff.visible" ), function ( modelRef )
		f12_local1:updateElementState( ElementalStaffsWidget, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	ElementalStaffsWidget:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f12_local1:updateElementState( ElementalStaffsWidget, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MaxisDroneBlueprintWidgetTomb:mergeStateConditions( {
		{
			stateName = "Scoreboard",
			condition = function ( menu, element, event )
				local f90_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN )
				if f90_local0 then
					f90_local0 = AlwaysFalse()
				end
				return f90_local0
			end
		}
	} )
	MaxisDroneBlueprintWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
	...
	MaxisDroneBlueprintWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.show_maxis_drone_parts_widget" ), function ( modelRef )
		f12_local1:updateElementState( MaxisDroneBlueprintWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_WEAPON_HUD_VISIBLE ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_HARDCORE ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_GAME_ENDED ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_CAMERA_MODE_MOVIECAM ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_DEMO_ALL_GAME_HUD_HIDDEN ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_KILLCAM ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_FLASH_BANGED ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_UI_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IS_SCOPED ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_VEHICLE ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_GUIDED_MISSILE ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_SCOREBOARD_OPEN ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_IN_REMOTE_KILLSTREAK_STATIC ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_EMP_ACTIVE ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	MusicalPartsWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.show_musical_parts_widget" ), function ( modelRef )
		f12_local1:updateElementState( MusicalPartsWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	CaptureGeneratorWheelWidgetTomb:mergeStateConditions( {
		{
			stateName = "Visible",
			condition = function ( menu, element, event )
				local f111_local0 = IsInventoryWidgetVisible( controller, "capture_generator_wheel_widget" )
				if f111_local0 then
					f111_local0 = Engine.IsVisibilityBitSet( controller, Enum.UIVisibilityBit.BIT_HUD_VISIBLE )
				end
				return f111_local0
			end
		}
	} )
	CaptureGeneratorWheelWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "zmInventory.capture_generator_wheel_widget" ), function ( modelRef )
	...
	CaptureGeneratorWheelWidgetTomb:subscribeToModel( Engine.GetModel( Engine.GetModelForController( controller ), "UIVisibilityBit." .. Enum.UIVisibilityBit.BIT_HUD_VISIBLE ), function ( modelRef )
		f12_local1:updateElementState( CaptureGeneratorWheelWidgetTomb, {
			name = "model_validation",
			menu = f12_local1,
			modelValue = Engine.GetModelValue( modelRef ),
	...
	self:subscribeToGlobalModel( controller, "PerController", "TombEndGameBlackScreen", function ( modelRef )
