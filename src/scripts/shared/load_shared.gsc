...
function __init__()
{
	...
	{
		logline1 = "load_shared.gsc __init__() game is zombies game " + "\n";
		logprint( logline1 );
...
{
	logline1 = "load_shared.gsc all_players_spawned() is called" + "\n";
	logprint( logline1 );
	level flag::wait_till( "all_players_connected" );
	logline1 = "load_shared.gsc all_players_spawned() flag met: all_players_connected" + "\n";
	logprint( logline1 );
